...
| [`MediaSourceControl`](./src/controls/MediaSourceControl/README.md) | Provides native-style library, upload, URL, featured-image and drop-zone sources with independent switches. | `import { MediaSourceControl } from '@isudev/gutenberg/controls/MediaSourceControl';` |
