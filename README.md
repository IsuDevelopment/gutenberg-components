...
- **For coding agents** — the package ships
  [`AGENTS.md`](./packages/gutenberg/AGENTS.md) and `catalog.json`, both generated by
  `npm run catalog`. In a project that consumes the library, `npx @isudev/gutenberg init`
